...
//	printf("Channel ID= %04X\n",sys_ch0);
	...
	if(sr)
		{
		for(i=0;i<sr;i++)fprintf(out,"%04X %02d.%02d.%02d %02d:%02d:%02d %lf %d\n",sys_ch0,dec_start[0],dec_start[1],dec_start[2],dec_start[3],dec_start[4],dec_start[5],i*1./sr,lbuf[i]);
		}
